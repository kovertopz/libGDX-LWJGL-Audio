...
public class RandomXS128 extends Random {
    ...
    /**
     * Creates a new random number generator. This constructor sets the seed of the random number generator to a value
    ...
    /**
     * Returns the next pseudo-random, uniformly distributed {@code long} value from this random number generator's
     * sequence.
     * <p>
    ...
    /**
     * Returns the next pseudo-random, uniformly distributed {@code int} value from this random number generator's
     * sequence.
     * <p>
    ...
    /**
     * Returns a pseudo-random, uniformly distributed {@code int} value between 0 (inclusive) and the specified value
    ...
    /**
     * Returns a pseudo-random, uniformly distributed {@code double} value between 0.0 and 1.0from this random number
    ...
    /**
     * Returns a pseudo-random, uniformly distributed {@code float} value between 0.0 and 1.0 from this random number
     * generator's sequence.
     * <p>
     * This implementation uses {@link #nextLong()} internally.
     *
    ...
    /**
     * Returns a pseudo-random, uniformly distributed {@code boolean } value from this random number generator's
     * sequence.
     * <p>
     * This implementation uses {@link #nextLong()} internally.
     *
     ...
     * <p>
     * The given seed is passed twice through an hash function. This way, if the user passes a small value we avoid the
     * short irregular transient associated with states having a very small number of bits set.
     *
     * @param seed a nonzero seed for this generator (if zero, the generator will be seeded with
     * {@link Long#MIN_VALUE}).
     */
    @Override
     ...
     */
    public final void setState(final long seed0, final long seed1) {
        this.seed0 = seed0;
        this.seed1 = seed1;
    }
