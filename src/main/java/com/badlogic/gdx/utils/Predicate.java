...
public interface Predicate<T> {
    ...
    public class PredicateIterator<T> implements Iterator<T> {
        ...
        public final void set(final Iterator<T> iterator, final Predicate<T> predicate) {
    ...
    public static class PredicateIterable<T> implements Iterable<T> {
        ...
        public final void set(Iterable<T> iterable, Predicate<T> predicate) {
            this.iterable = iterable;
            this.predicate = predicate;
        }

        /**
         * Returns an iterator. Note that the same iterator instance is returned each time this method is called. Use
