...
public class Array<T> implements Iterable<T> {
    ...
    /**
     * Returns an index of last occurrence of value in array or -1 if no such value exists. Search is started from the
     * end of an array.
     *
     * @param value
     * @param identity If true, == comparison will be used. If false, .equals() comparison will be used.
    ...
    /**
     * Selects the nth-lowest element from the Array according to Comparator ranking. This might partially sort the
     * Array. The array must have a size greater than 0, or a {@link com.badlogic.gdx.utils.GdxRuntimeException} will be
     * thrown.
     *
     * @see Select
     * @param comparator used for comparison
     * @param kthLowest rank of desired object according to comparison, n is based on ordinal numbers, not array
     * indices. for min value use 1, for max value use size of array, using 0 results in runtime exception.
    ...
    /**
     * Returns an iterable for the selected items in the array. Remove is supported, but not between hasNext() and
     * next(). Note that the same iterable instance is returned each time this method is called. Use the
    ...
    /**
     * Returns the items as an array. Note the array is typed, so the {@link #Array(Class)} constructor must have been
     * used. Otherwise use {@link #toArray(Class)} to specify the array type.
     *
     * @return
     */
    public T[] toArray() {
