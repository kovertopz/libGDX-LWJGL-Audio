...
class TimSort<T> {
     ...
     * start <= hi} @ param c comparator to used for the sort
     */
     ...
     * param c the comparator to used for the sort @return the length of the run beginning at the spec ified position in
     * the specified array
     */
     ...
     * this method will run. @param c the comparator used to order the range, and to search @return the i n t k, 0 <= k
     * <= n such that a[b + k - 1] < key <= a[b + k], pretending that a[b - 1] is minus infinity and a[b + n] is
     * infinity. In other words, key belongs at index b + k; or in other words, the first k elements of a should precede
     * key, and the last n - k should follow it.
     */
